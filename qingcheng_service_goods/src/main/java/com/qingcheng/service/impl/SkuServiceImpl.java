    ...
    public void importData() throws IOException {
        ...
        for (int i = 0; i < a + 1; i++) {
            ...
            for (int j = 0; j <= 1000; j++) {
                if (skuIndex + j > skuList.size()) {
                    break;
                }
                IndexRequest indexRequest = new IndexRequest("abc", "doc");
                Sku sku = skuList.get(skuIndex + j);
