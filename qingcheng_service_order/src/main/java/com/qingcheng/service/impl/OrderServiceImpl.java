...
public class OrderServiceImpl implements OrderService {
    ...
    public int xiadanrenshu() {
        return orderMapper.xiadanrenshu();
    }

    @Override
    public int dingdanshu() {
        return orderMapper.dingdanshu();
    }

    @Override
    public int tuikuanjiane() {
        return orderMapper.tuikuanjiane();
    }

    @Override
    public int fukuanrenshu() {
        return orderMapper.fukuanrenshu();
    }

    @Override
    public int fukianjine() {
        return orderMapper.fukianjine();
    }
