...
import com.qingcheng.pojo.user.Role;
import com.qingcheng.service.user.RoleService;
    ...
    private Example createExample(Map<String, Object> searchMap){
        ...
        if(searchMap!=null){
            ...
            if(searchMap.get("rolename")!=null && !"".equals(searchMap.get("rolename"))){
                criteria.andLike("rolename","%"+searchMap.get("rolename")+"%");
            }
            // roleDesc
            if(searchMap.get("roleDesc")!=null && !"".equals(searchMap.get("roleDesc"))){
                criteria.andLike("roleDesc","%"+searchMap.get("roleDesc")+"%");
            }
